...
export default function Container() {
    ...
    return(
        <div className={'font-sans antialiased leading-normal tracking-wider bg-cover ' + currentTheme.textClass} style={{ backgroundImage: "url(" + getAssetUrl('/background.jpg') + ")" }}>
